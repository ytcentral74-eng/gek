...
const PostCard: React.FC<PostCardProps> = ({ post, onLike, onComment, onShare, onUserClick }) => {
    ...
    <div className="w-full max-w-[470px] mx-auto border-b border-gray-200 pb-4 mb-4">
      ...
      <div className="flex items-center justify-between p-3">
        <div className="flex items-center gap-4">
          ...
          <button onClick={() => onShare(post)} className="transition-transform active:scale-90 hover:opacity-60">
